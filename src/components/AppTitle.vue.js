...
function __VLS_template() {
    ...
    __VLS_intrinsicElements.div;
    {
        ...
        var __VLS_2_1 = __VLS_1.apply(void 0, __spreadArray([__assign({}, { class: ("card") })], __VLS_functionalComponentArgsRest(__VLS_1), false));
        ({}(__assign({}, { class: ("card") })));
        {
        ...
        {
            var __VLS_10_1 = __VLS_intrinsicElements["div"];
            var __VLS_11 = __VLS_elementAsFunctionalComponent(__VLS_10_1);
            var __VLS_12_1 = __VLS_11.apply(void 0, __spreadArray([__assign({})], __VLS_functionalComponentArgsRest(__VLS_11), false));
            ({}(__assign({})));
            (__VLS_13.slots).default;
            var __VLS_13 = __VLS_pickFunctionalComponentCtx(__VLS_10_1, __VLS_12_1);
        }
        {
            var __VLS_15_1 = __VLS_intrinsicElements["div"];
            var __VLS_16 = __VLS_elementAsFunctionalComponent(__VLS_15_1);
            var __VLS_17_1 = __VLS_16.apply(void 0, __spreadArray([__assign({})], __VLS_functionalComponentArgsRest(__VLS_16), false));
            ({}(__assign({})));
